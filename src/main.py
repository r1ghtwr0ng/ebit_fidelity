...
def main():
    ...
    loss_probabilities = np.linspace(0, 1, 10)
    ...
    avg_fidelities, avg_attempts = extract_data(results)
    logging.info(
        f"Average fidelities: {avg_fidelities}, Average attempts: {avg_attempts}"
    )
